module.exports = function (grunt) {
  ...
  var OUTPUT_PATH = './dist/javascripts/marty-todo.js';
  ...
  grunt.initConfig({
    ...
    exorcise: {
      bundle: {
        files: {
          './dist/javascripts/marty-todo.map': [OUTPUT_PATH]
        }
      }
    },
    uglify: {
      release: {
        options: {
          ...
          sourceMapIn: 'dist/javascripts/marty-todo.map'
        },
        files: {
          'dist/javascripts/marty-todo.min.js': ['dist/javascripts/marty-todo.js']
        }
      }
    }
  });
